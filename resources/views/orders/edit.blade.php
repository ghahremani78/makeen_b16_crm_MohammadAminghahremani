      ...
      @csrf
        ...
        <div class="mb-3 mt-3">
          ...
          <input
            ...
            class="form-control"
            id="codeposti"
            placeholder="کدپستی راوارد نمایید"
            name="codeposti"
            value="{{ $orders->codeposti }}"
